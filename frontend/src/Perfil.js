            ...
            <Card.Body>
              {userData ? (
                <>
                  ...
                  <Row className="mb-3">
                    <Col sm={4}><strong>Rol:</strong></Col>
                    <Col sm={8}>
                      <Badge bg={userData.rol_nombre === 'Administrador' ? 'success' : 'secondary'}>
                        {userData.rol_nombre}
                      </Badge>
                    </Col>
                  </Row>
                  ...
                  {auth.user?.rol_id === 1 && (
                    <Card className="bg-light mb-3 shadow-sm">
                      <Card.Body>
                        <h5 className="mb-3 text-primary">Panel de Administrador</h5>
                        <Button
                          variant="primary"
                          className="me-2 mb-2"
                ...
                <p className="text-center text-muted">No se pudo cargar la información del perfil.</p>
              )}
            </Card.Body>
          </Card>
        </Col>
